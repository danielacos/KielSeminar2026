...
\begin{frame}{Bilinear control problem for Keller-Segel}
  ...
  \begin{itemize}
    ...
    \item \underline{Strategy:} train the parameters $\theta\in \R^P$ of a \structure{Fourier series} or \structure{neural network} $f_h(\theta)$ so that \alert{$f\approx f_h(\theta)$ mimimizes $J(u)$}.
  \end{itemize}
\end{frame}
...
\begin{frame}{Preliminary numerical simulation}
    ...
    \only<1>{
        \begin{tabular}{ccc}
            ...
            \\
            \hspace*{-0.7cm}Control $f$&\hspace*{0.3cm}Chemoattractant $v$&\hspace*{0.3cm}Cell density $u$
        \end{tabular}
    }
    ...
    \begin{itemize}
        ...
        \only<1>{
            \begin{tabular}{cc}
                ...
                \hspace*{-0.7cm}Tumor&\hspace*{0.3cm}Nutrients
            \end{tabular}
        }
        \only<2>{
        \if\animation1
        ...
        \only<3>{
            \begin{tabular}{cc}
                ...
                \\
                \hspace*{-0.7cm}Real image&\hspace*{0.3cm}Numerical simulation
            \end{tabular}
        }
